...
# python demo/large_image_demo.py /media/2020/AIBSc002_gliang/LG/bird/data/MVA2023_Challenge/data/mva2023_sod4bird_pub_test/images_little configs/yolov5/yolov5_s-v61_syncbn_8xb16-300e_bird_infer.py /media/2020/AIBSc002_gliang/LG/bird/mmyolo/work_dirs/yolov5_s-v61_syncbn_8xb16-300e_bird/best_coco/bbox_mAP_epoch_200.pth --tta
def parse_args():
    parser = ArgumentParser(
        description='Perform MMYOLO inference on large images.')
    parser.add_argument(
        '--img', default='/media/2020/AIBSc002_gliang/LG/bird/data/MVA2023_Challenge/data/mva2023_sod4bird_pub_test/images_little', help='Image path, include image file, dir and URL.')
    parser.add_argument('--config', default='../configs/yolov5/yolov5_s-v61_syncbn_8xb16-300e_bird_infer.py', help='Config file')
    parser.add_argument('--checkpoint',default='/media/2020/AIBSc002_gliang/LG/bird/mmyolo/work_dirs/yolov5_s-v61_syncbn_8xb16-300e_bird/best_coco/bbox_mAP_epoch_220.pth', help='Checkpoint file')
    parser.add_argument(
    ...
    parser.add_argument(
        '--json-prefix',
        # default='/media/2020/AIBSc002_gliang/LG/bird/data/MVA2023_Challenge/data/mva2023_sod4bird_pub_test/annotations/public_test_coco_empty_ann.json',
        type=str,
...
def main():
    ...
    if args.json_prefix is not None:
        ...
        config.merge_from_dict(cfg_json)

    # Determine whether the custom metainfo fields are all lowercase
    is_metainfo_lower(config)
